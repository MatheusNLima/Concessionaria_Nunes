...
function Header({ termoBusca, onBuscaChange, onNavigateHome, onNavigateInteresses, onNavigateLogin, onNavigateRegister }) {
        ...
        <header ref={headerElementRef}>
            ...
            <nav id="nav-menu" className={menuAtivo ? 'ativo' : ''}>
                <ul>
                    ...
                    <li><a href="#" onClick={(e) => handleNavClick(onNavigateLogin, e)}>Entrar</a></li>
                    <li><a href="#" onClick={(e) => handleNavClick(onNavigateRegister, e)}>Cadastrar</a></li>
                </ul>
            </nav>
        </header>
    );
